...
var dispatcher        = new Dispatcher( "action -> align left" );
...
exports.execute = function(){
 ...
 return  Promises.chaining([
                         ...
                         DriverMod.WaitForElement( 'xpath' , "// button [ @data-format = 'text-alignment-left' ]"),
                         DriverMod.ClickOn       ( 'xpath' , "// button [ @data-format = 'text-alignment-left' ]"),
                         DriverMod.FindElement   ('css', ".smashdoc-selected-section").getAttribute("data-alignment"),
                         alignment => assert.Equals(alignment, "left","alignment: " + "left"),
